...
public abstract class Database {
    ...
    protected void createTables() throws SQLException {
        ...
        state.execute("CREATE TABLE IF NOT EXISTS users(id Integer, fName varchar(20), lName varchar(20), userName varchar(20),email varchar(40),password varchar(20), status boolean, accToken varchar(64), primary key (id));");
        close(state);
    }
}
